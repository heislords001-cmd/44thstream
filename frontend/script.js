...
// ============================================================
// ANIME — Kitsu API (Reliable, No Key)
// ============================================================
...
async function playEpisode(index) {
  ...
  // Placeholder — Kitsu and TVMaze don't provide streaming links
  container.innerHTML = `
